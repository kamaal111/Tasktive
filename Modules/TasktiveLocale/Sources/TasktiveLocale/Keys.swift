...
extension TasktiveLocale {
    public enum Keys: String {
        ...
        case UPDATE_TASK_ERROR_DESCRIPTION
        case DELETE_TASK_ERROR_DESCRIPTION
        case GENERAL_WARNING_TITLE
        ...
        case NOTIFICATION_UNAUTHORIZED_WARNING_TITLE
        case NOTIFICATION_UNAUTHORIZED_WARNING_DESCRIPTION
        case VERSION
        case ABOUT
        case FEEDBACK
        case FEATURES
